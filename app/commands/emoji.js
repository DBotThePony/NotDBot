...
Message {
  channel:
   TextChannel {
     type: 'text',
     id: '122200640679182336',
     name: 'tumblr_chat',
     position: 4,
     permissionOverwrites:
      Collection {
        '109526757312344064' => [Object],
        _array: null,
        _keyArray: null },
     topic: 'NSFW SHIT. GET OUT. RUN. PLEASE. NOW.',
     lastMessageID: '251288811189960705',
     guild:
      Guild {
        members: [Object],
        channels: [Object],
        roles: [Object],
        available: true,
        id: '109526757312344064',
        name: 'Ponyscape',
        icon: '6c3a15dae0b5d05789ce466ec389a9a2',
        splash: null,
        region: 'us-east',
        memberCount: 139,
        large: undefined,
        ...
        emojis: [Object],
        afkTimeout: 3600,
        afkChannelID: '109526760772644864',
        embedEnabled: undefined,
        verificationLevel: 2,
        joinedTimestamp: 1479649801983,
        ownerID: '76232498052345856',
        _rawVoiceStates: [Object] },
     messages:
      Collection {
        '251306060592316416' => [Object],
        _array: null,
        _keyArray: null },
     _typing: Map { '141004095145115648' => [Object] } },
  id: '251306060592316416',
  type: 'DEFAULT',
  content: '<:squish:234154983707246593>',
  author:
   User {
   ...
   GuildMember {
     ...
     user:
      User {
        ...
        avatar: 'cb4e45f6b0945a87482e9ad602423182',
        bot: false },
     _roles: [ '122186261040594948', '155588294606979078' ],
     serverDeaf: false,
     serverMute: true,
     selfMute: undefined,
     selfDeaf: undefined,
     ...
     speaking: false,
     nickname: null,
     joinedTimestamp: 1453688396031 },
  pinned: false,
  tts: false,
  nonce: '251306060806094848',
  system: false,
  embeds: [],
  attachments: Collection { _array: [], _keyArray: null },
  createdTimestamp: 1479986433886,
...
var regExpObj = new RegExp('!?(' + regExp + '|<:[a-zA-Z_0-9]+:([0-9]+)>|\n|' + avaliableCharEmoji.join('|') + ')', 'gi');
var customEmoji = new RegExp('<:[a-zA-Z_0-9]+:([0-9]+)>', 'gi');
var emojiBase = 'https://cdn.discordapp.com/emojis/';
...
module.exports = {
	...
	func: function(args, cmd, msg) {
		...
		var emojiCollection = [];
		var emojiMatch = cmd.match(regExpObj);
		var customEmojiAmount = 0;
		...
		var continueFunc = function() {
			...
			var fpath = DBot.WebRoot + '/emoji/' + sha + '.png';
			...
			fs.stat(fpath, function(err, stat) {
				if (stat) {
					...
					var magikArgs = ['-background', 'rgba(0,0,0,0)'];
