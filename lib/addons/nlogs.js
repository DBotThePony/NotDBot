...
MySQL.query('CREATE TABLE IF NOT EXISTS `name_logs` (`ID` INTEGER NOT NULL, `SERVER` INTEGER NOT NULL, `NAME` VARCHAR(255) NOT NULL, `LASTUSE` INTEGER NOT NULL, `TIME` DOUBLE NOT NULL, PRIMARY KEY (`ID`, `SERVER`, `NAME`))');
