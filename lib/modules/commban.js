...
DBot.DefineMySQLTable('command_bans_channel', 'UID INTEGER NOT NULL, COMMAND VARCHAR(64) NOT NULL');
DBot.DefineMySQLTable('command_bans_server', 'UID INTEGER NOT NULL, COMMAND VARCHAR(64) NOT NULL');
