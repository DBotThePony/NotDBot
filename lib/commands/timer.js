...
DBot.DefineMySQLTable('timers_ids', 'ID INTEGER NOT NULL AUTO_INCREMENT, TITLE VARCHAR(128) NOT NULL, STAMP INTEGER NOT NULL, PRIMARY KEY (ID)');
	...
	func: function(args, cmd, rawcmd, msg) {
		...
		fs.stat(fpath, function(err, stat) {
			if (stat) {
				...
				MySQL.query('INSERT INTO timers_ids (TITLE, STAMP) VALUES (' + MySQL.escape(title) + ', ' + unix + ')', function(err, data) {
					if (err) {
