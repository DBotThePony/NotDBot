...
fs.readdir('./resource/fortune_vulgar', function(err, files) {
	...
	MySQL.query('CREATE TABLE IF NOT EXISTS `fortune_vulgar` (`ID` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, `CATEGORY` CHAR(16) NOT NULL, `CONTENT` TEXT NOT NULL)', function() {
